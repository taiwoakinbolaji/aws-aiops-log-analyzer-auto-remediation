...
# ============================================================================
# Remediator Lambda Deployment Script
# ============================================================================
# This script packages and deploys the Remediator Lambda function code
...
# Configuration
FUNCTION_NAME=${1:-"aiops-log-analyzer-dev-remediator"}
REGION=${AWS_REGION:-"us-east-1"}
PACKAGE_FILE="remediator-deployment-package.zip"
export AWS_PAGER=""

echo -e "${GREEN}=====================================${NC}"
echo -e "${GREEN}Remediator Lambda Deployment${NC}"
echo -e "${GREEN}=====================================${NC}"
echo ""
